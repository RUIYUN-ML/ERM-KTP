...
class ResNext(nn.Module):
    ...
    def __init__(self, block, num_blocks, class_names=100, ifmask=True):
        super().__init__()
        self.in_channels = 64
        ...
        if ifmask:
            self.lmask = LearnableMaskLayer(2048, num_classes=class_names)
    ...
    def forward(self, x, labels=None, target=None):
        ...
        if labels is not None:
            ...
            return x, feature_map0, feature_map1
        else:
            return x
...
def resnext50(num_classes, ifmask=True):
    """ return a resnext50(c32x4d) network
    """
    return ResNext(ResNextBottleNeckC, [3, 4, 6, 3], num_classes, ifmask)